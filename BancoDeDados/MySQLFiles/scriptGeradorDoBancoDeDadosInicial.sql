...
-- -----------------------------------------------------
-- Table `mydb`.`clientUser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`clientUser` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb`.`cleanerUser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`cleanerUser` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `User_ID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`service` (
  ...
  CONSTRAINT `fk_service_cleanerUser1`
    ...
    REFERENCES `mydb`.`cleanerUser` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_service_clientUser1`
    FOREIGN KEY (`clientUser_ID`)
    REFERENCES `mydb`.`clientUser` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
